...
public class TTR_UI_Seno extends javax.swing.JFrame {

    /**
     * Creates new form TTR_UI_Seno
     */
    public TTR_UI_Seno() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel5.setPreferredSize(new java.awt.Dimension(0, 90));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TTR_UI_Seno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TTR_UI_Seno().setVisible(true);
            }
        });
    }
